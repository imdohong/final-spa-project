...
const router = useRouter(); // ✈️ useRouter 뒤로가기 조종용
...
.tagline { font-size: 20px; font-style: italic; color: #a4b0be; margin-bottom: 30px; padding-left: 15px; border-left: 3px solid #747d8c; }
